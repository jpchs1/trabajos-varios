...
- **[Desaduanar una lancha en San Antonio](aduanas-lancha/)** — Ocho agencias de aduana con oficina o cobertura en el Puerto de San Antonio para cotizar el desaduanamiento de una lancha sobre carro llegada directo desde EE.UU., con la pauta de los doce ítems de costo que deben responder, los antecedentes a entregar, las preguntas clave y el correo de solicitud listo para copiar. En línea en [`jpchs1.github.io/trabajos-varios/aduanas-lancha/`](https://jpchs1.github.io/trabajos-varios/aduanas-lancha/).
