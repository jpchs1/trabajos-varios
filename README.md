...
- **[Internación de autos eléctricos a Chile](importacion-autos-electricos/)** — Guía operativa del circuito aduanero para nacionalizar un auto eléctrico nuevo importado por un particular: el filtro de «sin uso» de la Ley 18.483, los siete pasos desde la DIN hasta la placa patente, qué tributos se pagan y cuáles no, y cómo elegir agente de aduana con la nómina oficial del Servicio Nacional de Aduanas. Publicable en `https://jpchs1.github.io/trabajos-varios/importacion-autos-electricos/`.
