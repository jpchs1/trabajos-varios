...
- **[Propuestas Tourevo](propuestas/)** — Cotizaciones de viaje en HTML, una carpeta por cliente. Actual: [Segar — San Pedro de Atacama](propuestas/segar-san-pedro-atacama/) (COT-2026-0160), con su PDF listo para enviar. Cada carpeta puede llevar un `NOTAS-INTERNAS.md` con la revisión previa al envío; el deploy excluye los `.md`, así que no se publica. Las cotizaciones anteriores (Crystal Low COT-2026-0158 y Kiran Shah COT-2026-0159) se movieron a [`jpchs1/tourevo-cl`](https://github.com/jpchs1/tourevo-cl) en el commit `5cf66d2`; su historial sigue disponible acá.
