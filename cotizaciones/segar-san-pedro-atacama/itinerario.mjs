...
export const DIAS = [
  ...
  { f: '2026-12-24', n: { es: 'Puritama, Quitor y Nochebuena', en: 'Puritama, Quitor and Christmas Eve' }, blks: [
    { h: '09:30', f2: '13:30', tipo: 'tourevo', e: 'igual',
      ...
      conf: { es: '¿Confirman Puritama el 24 de 09:30 a 13:30, con regreso a San Pedro a esa hora? De ahí sale la salida de las 14:30 a Quitor, así que el cierre puntual importa. ¿Hay recargo por Nochebuena?',
              en: 'Do you confirm Puritama on the 24th from 09:30 to 13:30, back in San Pedro by then? The 14:30 departure to Quitor runs off it, so closing on time matters. Is there a Christmas Eve supplement?' } },
    { h: '13:30', f2: '14:30', tipo: 'libre', e: 'nuevo',
      t: { es: 'Almuerzo y descanso', en: 'Lunch and rest' } },
    { h: '14:30', f2: '18:30', tipo: 'tourevo', e: 'movido',
      cot: ['arqueologico', 'marte-sandboard'],
  ...
  { f: '2026-12-26', n: { es: 'Día libre y salida', en: 'Free day and departure' }, blks: [
    ...
    { h: '10:24', f2: '11:44', tipo: 'tourevo', e: 'igual',
      ...
      conf: { es: '¿Confirman la recogida en el hotel a las 10:24 para llegar a Calama 11:44, con el vuelo de las 13:44? Si prefieren más margen, se puede adelantar.',
              en: 'Do you confirm hotel pickup at 10:24 to reach Calama at 11:44, for the 13:44 flight? If you would rather have more margin, it can be brought forward.' } },
